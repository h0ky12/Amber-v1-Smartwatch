...
C_DEPS += \
./lvgl/examples/libs/libwebp/lv_example_libwebp_1.d 


# Each subdirectory must supply rules for building sources it contributes
lvgl/examples/libs/libwebp/%.o lvgl/examples/libs/libwebp/%.su lvgl/examples/libs/libwebp/%.cyclo: ../lvgl/examples/libs/libwebp/%.c lvgl/examples/libs/libwebp/subdir.mk
...
clean: clean-lvgl-2f-examples-2f-libs-2f-libwebp

clean-lvgl-2f-examples-2f-libs-2f-libwebp:
	-$(RM) ./lvgl/examples/libs/libwebp/lv_example_libwebp_1.cyclo ./lvgl/examples/libs/libwebp/lv_example_libwebp_1.d ./lvgl/examples/libs/libwebp/lv_example_libwebp_1.o ./lvgl/examples/libs/libwebp/lv_example_libwebp_1.su

.PHONY: clean-lvgl-2f-examples-2f-libs-2f-libwebp
