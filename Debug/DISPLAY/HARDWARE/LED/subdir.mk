...
C_SRCS += \
../DISPLAY/HARDWARE/LED/led.c 

OBJS += \
./DISPLAY/HARDWARE/LED/led.o 

C_DEPS += \
./DISPLAY/HARDWARE/LED/led.d 


# Each subdirectory must supply rules for building sources it contributes
DISPLAY/HARDWARE/LED/%.o DISPLAY/HARDWARE/LED/%.su DISPLAY/HARDWARE/LED/%.cyclo: ../DISPLAY/HARDWARE/LED/%.c DISPLAY/HARDWARE/LED/subdir.mk
...
clean: clean-DISPLAY-2f-HARDWARE-2f-LED

clean-DISPLAY-2f-HARDWARE-2f-LED:
	-$(RM) ./DISPLAY/HARDWARE/LED/led.cyclo ./DISPLAY/HARDWARE/LED/led.d ./DISPLAY/HARDWARE/LED/led.o ./DISPLAY/HARDWARE/LED/led.su

.PHONY: clean-DISPLAY-2f-HARDWARE-2f-LED
