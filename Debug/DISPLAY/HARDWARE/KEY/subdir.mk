...
C_SRCS += \
../DISPLAY/HARDWARE/KEY/key.c 

OBJS += \
./DISPLAY/HARDWARE/KEY/key.o 

C_DEPS += \
./DISPLAY/HARDWARE/KEY/key.d 


# Each subdirectory must supply rules for building sources it contributes
DISPLAY/HARDWARE/KEY/%.o DISPLAY/HARDWARE/KEY/%.su DISPLAY/HARDWARE/KEY/%.cyclo: ../DISPLAY/HARDWARE/KEY/%.c DISPLAY/HARDWARE/KEY/subdir.mk
...
clean: clean-DISPLAY-2f-HARDWARE-2f-KEY

clean-DISPLAY-2f-HARDWARE-2f-KEY:
	-$(RM) ./DISPLAY/HARDWARE/KEY/key.cyclo ./DISPLAY/HARDWARE/KEY/key.d ./DISPLAY/HARDWARE/KEY/key.o ./DISPLAY/HARDWARE/KEY/key.su

.PHONY: clean-DISPLAY-2f-HARDWARE-2f-KEY
