...
C_SRCS += \
../DISPLAY/HARDWARE/MPU/mpu.c 

OBJS += \
./DISPLAY/HARDWARE/MPU/mpu.o 

C_DEPS += \
./DISPLAY/HARDWARE/MPU/mpu.d 


# Each subdirectory must supply rules for building sources it contributes
DISPLAY/HARDWARE/MPU/%.o DISPLAY/HARDWARE/MPU/%.su DISPLAY/HARDWARE/MPU/%.cyclo: ../DISPLAY/HARDWARE/MPU/%.c DISPLAY/HARDWARE/MPU/subdir.mk
...
clean: clean-DISPLAY-2f-HARDWARE-2f-MPU

clean-DISPLAY-2f-HARDWARE-2f-MPU:
	-$(RM) ./DISPLAY/HARDWARE/MPU/mpu.cyclo ./DISPLAY/HARDWARE/MPU/mpu.d ./DISPLAY/HARDWARE/MPU/mpu.o ./DISPLAY/HARDWARE/MPU/mpu.su

.PHONY: clean-DISPLAY-2f-HARDWARE-2f-MPU
