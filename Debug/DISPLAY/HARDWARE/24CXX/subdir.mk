...
C_SRCS += \
../DISPLAY/HARDWARE/24CXX/24cxx.c 

OBJS += \
./DISPLAY/HARDWARE/24CXX/24cxx.o 

C_DEPS += \
./DISPLAY/HARDWARE/24CXX/24cxx.d 


# Each subdirectory must supply rules for building sources it contributes
DISPLAY/HARDWARE/24CXX/%.o DISPLAY/HARDWARE/24CXX/%.su DISPLAY/HARDWARE/24CXX/%.cyclo: ../DISPLAY/HARDWARE/24CXX/%.c DISPLAY/HARDWARE/24CXX/subdir.mk
...
clean: clean-DISPLAY-2f-HARDWARE-2f-24CXX

clean-DISPLAY-2f-HARDWARE-2f-24CXX:
	-$(RM) ./DISPLAY/HARDWARE/24CXX/24cxx.cyclo ./DISPLAY/HARDWARE/24CXX/24cxx.d ./DISPLAY/HARDWARE/24CXX/24cxx.o ./DISPLAY/HARDWARE/24CXX/24cxx.su

.PHONY: clean-DISPLAY-2f-HARDWARE-2f-24CXX
