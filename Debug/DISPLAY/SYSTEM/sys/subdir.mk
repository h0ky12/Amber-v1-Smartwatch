...
C_SRCS += \
../DISPLAY/SYSTEM/sys/sys.c 

OBJS += \
./DISPLAY/SYSTEM/sys/sys.o 

C_DEPS += \
./DISPLAY/SYSTEM/sys/sys.d 


# Each subdirectory must supply rules for building sources it contributes
DISPLAY/SYSTEM/sys/%.o DISPLAY/SYSTEM/sys/%.su DISPLAY/SYSTEM/sys/%.cyclo: ../DISPLAY/SYSTEM/sys/%.c DISPLAY/SYSTEM/sys/subdir.mk
...
clean: clean-DISPLAY-2f-SYSTEM-2f-sys

clean-DISPLAY-2f-SYSTEM-2f-sys:
	-$(RM) ./DISPLAY/SYSTEM/sys/sys.cyclo ./DISPLAY/SYSTEM/sys/sys.d ./DISPLAY/SYSTEM/sys/sys.o ./DISPLAY/SYSTEM/sys/sys.su

.PHONY: clean-DISPLAY-2f-SYSTEM-2f-sys
