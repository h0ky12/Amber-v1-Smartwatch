...
C_SRCS += \
../DISPLAY/SYSTEM/delay/delay.c 

OBJS += \
./DISPLAY/SYSTEM/delay/delay.o 

C_DEPS += \
./DISPLAY/SYSTEM/delay/delay.d 


# Each subdirectory must supply rules for building sources it contributes
DISPLAY/SYSTEM/delay/%.o DISPLAY/SYSTEM/delay/%.su DISPLAY/SYSTEM/delay/%.cyclo: ../DISPLAY/SYSTEM/delay/%.c DISPLAY/SYSTEM/delay/subdir.mk
...
clean: clean-DISPLAY-2f-SYSTEM-2f-delay

clean-DISPLAY-2f-SYSTEM-2f-delay:
	-$(RM) ./DISPLAY/SYSTEM/delay/delay.cyclo ./DISPLAY/SYSTEM/delay/delay.d ./DISPLAY/SYSTEM/delay/delay.o ./DISPLAY/SYSTEM/delay/delay.su

.PHONY: clean-DISPLAY-2f-SYSTEM-2f-delay
